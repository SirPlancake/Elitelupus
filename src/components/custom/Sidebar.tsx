import {Unplug, House, Box, Image, GitCompare, Search} from "lucide-react";
...
const TopActions = [
  {name: "Dashboard", uri: "/", icon: House, status: "NONE"},
  {name: "Gallery", uri: "/gallery", icon: Image, status: "NONE"},
  {name: "Model Viewer", uri: "/viewer", icon: Box, status: "NONE"},
  {name: "Steam Lookup", uri: "/lookup", icon: Search, status: "BETA"},
];
