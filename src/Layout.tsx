...
export default function Layout() {
  ...
  return (
    <LayoutTopbarContext.Provider value={TopbarContextValue}>
      <div className="h-dvh overflow-hidden text-white p-3 flex flex-col bg-black bg-[linear-gradient(to_right,rgba(255,255,255,0.04)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.04)_1px,transparent_1px)] bg-size-[32px_32px]">
        ...
        <div className="flex flex-1 gap-3 relative min-h-0">
          ...
          <main className="relative flex min-h-0 flex-1 flex-col rounded-lg border border-zinc-800/75 bg-zinc-900/75 overflow-hidden">
            <div className={`border-b border-zinc-800 bg-zinc-950 p-3 rounded-t-lg min-h-20 flex-wrap items-center gap-3 ${TopbarHidden ? "hidden" : "flex"}`}>
              ...
              <a href="https://github.com/sponsors/SirPlancake" target="_blank" rel="noopener noreferrer" className="h-10.5 ml-auto mr-1 inline-flex shrink-0 hover:cursor-pointer items-center gap-2 rounded-md border border-lime-500/30 bg-lime-500/10 px-5 py-2 text-sm font-semibold text-lime-300 transition hover:bg-lime-500/20 hover:text-lime-200">
